    ...
    mopp.util.Notify('yellow', ply, "Вы "..str.." рацию.")
...
netstream.Hook("WalkieTalkie.MicroToggle", function(ply, data)
    ...
    mopp.util.Notify('yellow', ply, "Вы "..str.." микрофон рации.")
...
netstream.Hook("WalkieTalkie.ChangeChannel", function(ply, data)
    ...
    if not channel or channel < 0 or channel > 100 then
        ...
        mopp.util.Notify('red', ply, "Канал рации может быть не выше 100 и не ниже 0.")
    ...
    mopp.util.Notify('yellow', ply, "Вы изменили канал рации на "..data.channel..".")
...
local function send_group_message(ply, radio, text)
    ...
    if not radio then
        ...
        mopp.util.Notify("red", ply, "Вы не можете использовать групповой чат.")
